...
namespace Fungus
{
    ...
    public class SavePoint : Command
    {
        ...
        //保存点所有block的名字列表
        private static List<string> _savepointName = new List<string>();

        public static List<string> SavepointName
        {
            get
            {
        ...
        public override void OnEnter()
        {
            ...
            if (!SavepointName.Contains(SavePointKey))
            {
                SavepointName.Add(SavePointKey);
                MyBlockNameIO.instance.Write();
            }
            if (fireEvent)
            {
