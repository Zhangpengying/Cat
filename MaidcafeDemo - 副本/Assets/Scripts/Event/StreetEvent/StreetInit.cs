...
public class StreetInit : MonoBehaviour, SceneInitManager
{
    private void Start()
    {
    ...
    public void Initialize()
    {
        ...
        StaticVar.player.GetComponent<Transform>().localPosition = new Vector3(-8.69f, -7.68f, 0);
        StaticVar.player.GetComponent<Transform>().localScale = new Vector3(1.5f, 1.5f, 1.5f);
